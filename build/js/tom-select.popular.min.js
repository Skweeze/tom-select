...
const q=e=>null==e?null:D(e),D=e=>"boolean"==typeof e?e?"1":"0":e+"",R=e=>(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),N=(e,t)=>{var i
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,t))s in o&&n.apply(e,o[s])},B=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},z=(e,t,i,s)=>{e.addEventListener(t,i,s)},K=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),M=(e,t)=>{const i=e.getAttribute("id")
...
const n=J(s,t)
this.settings=n,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=M(s,"tomselect-"+U),this.isRequired=s.required,this.sifter=new w(this.options,{diacritics:n.diacritics}),n.mode=n.mode||(1===n.maxItems?"single":"multi"),"boolean"!=typeof n.hideSelected&&(n.hideSelected="multi"===n.mode),"boolean"!=typeof n.hidePlaceholder&&(n.hidePlaceholder="multi"!==n.mode)
...
var u
if(C(r,n.wrapperClass,d,p),C(l,n.controlClass),G(r,l),C(a,n.dropdownClass,p),n.copyClassesToDropdown&&C(a,d),C(c,n.dropdownContentClass),G(a,c),b(n.dropdownParent||r).appendChild(a),I(n.controlInput)){u=b(n.controlInput)
...
C([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&E(l,{multiple:"multiple"}),t.placeholder&&E(i,{placeholder:t.placeholder}),!t.splitOn&&t.delimiter&&(t.splitOn=new RegExp("\\s*"+m(t.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=N(t.load,t.loadThrottle)),e.control_input.type=l.type,z(s,"click",(t=>{const i=k(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),B(t,!0))})),z(r,"click",(t=>{var s=k(t.target,"[data-ts-item]",r)
s&&e.onItemSelect(t,s)?B(t,!0):""==i.value&&(e.onClick(),B(t,!0))})),z(a,"keydown",(t=>e.onKeyDown(t))),z(i,"keypress",(t=>e.onKeyPress(t))),z(i,"input",(t=>e.onInput(t))),z(a,"resize",(()=>e.positionDropdown()),c),z(a,"blur",(t=>e.onBlur(t))),z(a,"focus",(t=>e.onFocus(t))),z(a,"paste",(t=>e.onPaste(t)))
const v=t=>{const n=t.composedPath()[0]
if(!o.contains(n)&&!s.contains(n))return e.isFocused&&e.blur(),void e.inputState()
n==i&&e.isOpen?t.stopPropagation():B(t,!0)}
var f=()=>{e.isOpen&&e.positionDropdown()}
z(document,"mousedown",v),z(window,"scroll",f,c),z(window,"resize",f,c),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("scroll",f),window.removeEventListener("resize",f),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,z(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),C(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),y(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
else{switch(e.keyCode){case 65:if(K(j,e)&&""==t.control_input.value)return B(e),void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!K(j,e)&&B(e)}}onInput(e){var t=this
...
B(t)}else"click"===i&&K(j,t)||"keydown"===i&&K("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
const o=this
return"option"!==e&&"item"!=e||(n=D(t[o.settings.valueField])),null==(s=o.settings.render[e].call(this,t,R))||(s=b(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?E(s,{"aria-disabled":"true"}):E(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],E(s,{"data-group":i}),t.group[o.settings.disabledField]&&E(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(E(s,{"data-value":n}),"item"===e?(C(s,o.settings.itemClass),E(s,{"data-ts-item":""})):(C(s,o.settings.optionClass),E(s,{role:"option",id:t.$id}),o.options[n].$div=s))),s}clearCache(){y(this.options,((e,t)=>{e.$div&&(e.$div.remove(),delete e.$div)}))}uncacheValue(e){const t=this.getOption(e)
t&&t.remove()}canCreate(e){return this.settings.create&&e.length>0&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return W.define("auto_position",(function(){var e=this
const t="top",i="bottom"
e.positionDropdown=function(){const s="body"===e.settings.dropdownParent?{top:e.control.getBoundingClientRect().top,lefy:e.control.getBoundingClientRect().left}:{top:e.control.offsetTop,left:e.control.offsetLeft}
s.top+=e.control.getBoundingClientRect().height
const n=e.dropdown.scrollHeight+5,o=e.control.getBoundingClientRect().top+n+e.wrapper.getBoundingClientRect().height>window.innerHeight?t:i,r={width:e.control.getBoundingClientRect().width,left:s.left}
o===t?(Object.assign(r,{bottom:s.top+"px",top:"unset",margin:"0 0 5px 0",display:"none"}),e.dropdown.classList.add("selectize-position-top")):(Object.assign(r,{top:s.top+"px",bottom:"unset",margin:"5px 0 0 0",display:"none"}),e.dropdown.classList.remove("selectize-position-top")),Object.assign(e.dropdown.style,r)}})),W.define("checkbox_options",(function(){var e=this,t=e.onOptionSelect
e.settings.hideSelected=!1
var i=function(e){setTimeout((()=>{var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}),1)}
e.hook("after","setupTemplates",(()=>{var t=e.settings.render.option
e.settings.render.option=(i,s)=>{var n=b(t.call(e,i,s)),o=document.createElement("input")
...
t.call(e,s,n),i(n)}))})),W.define("collapse_multiple_items",(function(){const e=this,t=()=>{if("multi"!==e.settings.mode)return
const t=e.settings.collapsedItemsTemplate?e.settings.collapsedItemsTemplate:"# Selected"
let i=e.settings.placeholder
if(1===e.items.length){const t=e.getValue(),s=e.getOption(t[0])
i=null!=s&&s.textContent?s.textContent:""}e.items.length>1&&(i=t.replace("#",e.items.length.toString())),E(e.control_input,{placeholder:i})}
e.hook("after","inputState",(()=>{t()})),e.hook("after","setup",(()=>{t()}))})),W}))
